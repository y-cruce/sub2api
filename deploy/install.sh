...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/y-cruce/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/y-cruce/sub2api
