  ...
  admin: {
    ...
    accounts: {
      ...
      tempUnschedulable: {
        ...
        retryHint: 'Retry on match before setting rate limit and switching accounts',
        retryCount: 'Retry Count',
        retryCountHint: 'Retry count range: 1-10',
        ...
        presets: {
          ...
          overloadDesc: 'Overloaded - pause 60 seconds',
          rateLimitLabel: '429 Rate Limit',
          rateLimitDesc: 'Rate limited - retry 3 times then pause 30 seconds',
          unavailableLabel: '503 Unavailable',
          unavailableDesc: 'Unavailable - pause 30 seconds'
        }
      },
